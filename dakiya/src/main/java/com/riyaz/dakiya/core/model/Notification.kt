...
data class Notification(
    ...
    val style: String = Style.DEFAULT.name,
    val channel: String = "default"
){
    constructor(data: Map<String, String>): this(data.getOrNull("id")?.toInt() ?: Random(10000).nextInt(), data.getOrNull(TITLE)!!, data.getOrNull(SUBTITLE), data.getOrNull(IMAGE), data.getOrNull(TEMPLATE) ?: Style.DEFAULT.name)
}
